...
public class HotelApiTest {
    ...
    private String getCreateHotelByJson() {
        ...
        return String.format(
                ...
                dto.getBarbecue()
                , dto.getSauna(), dto.getSwimmingPool(), dto.getRestaurant(), dto.getRoofTop(), dto.getFitness(),
                dto.getDryer()
                , dto.getBreakfast(), dto.getSmokingArea(), dto.getAllTimeDesk(), dto.getLuggageStorage(),
                dto.getSnackBar()
                , dto.getPetFriendly()
        );
    }
