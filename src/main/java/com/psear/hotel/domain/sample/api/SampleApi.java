package com.psear.hotel.domain.sample.api;

import com.psear.hotel.domain.sample.application.SampleService;
...
import com.psear.hotel.global.common.response.ApiResponse;
import java.net.URI;
