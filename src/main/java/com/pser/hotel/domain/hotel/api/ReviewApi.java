...
public class ReviewApi {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<Page<ReviewResponse>>> getAll(Pageable pageable, @PathVariable Long reservationId) {
        Page<ReviewResponse> result = reviewService.getAllByReservationId(reservationId, pageable);
        return ResponseEntity.ok(ApiResponse.success(result));
    }

    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<ReviewResponse>> getById(@PathVariable Long reservationId, @PathVariable Long id) {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<Long>> save(@PathVariable Long reservationId, @Valid @RequestBody ReviewCreateRequest request) {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse<Void>> update(@PathVariable Long reservationId, @PathVariable Long id, @Valid @RequestBody ReviewUpdateRequest request) {
